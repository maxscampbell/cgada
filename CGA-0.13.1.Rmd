...
suppressMessages(
  ...
  theme(legend.position = "none") +
  annotate(geom = "text", x = 2.16, y = 23.5, label = "Coin-specialized", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 2.8, y = 23.5, label = "Strong", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 2.16, y = 18.5, label = "Weak", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 2.8, y = 18.5, label = "Kill-specialized", color = "black", alpha = 0.4)
)
```
