...
dflist <- list(october5, october19, november2)
...
suppressMessages(
  ...
  theme(legend.position = "none") +
  annotate(geom = "text", x = 0.45, y = 23, label = "Coin-specialized", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 1.35, y = 23, label = "High Event", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 0.45, y = 11, label = "Low Event", color = "black", alpha = 0.4) +
  annotate(geom = "text", x = 1.35, y = 11, label = "Kill-specialized", color = "black", alpha = 0.4)
)
```
